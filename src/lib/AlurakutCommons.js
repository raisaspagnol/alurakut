...
export function OrkutNostalgicIconSet(props) {
  return (
    <OrkutNostalgicIconSet.List>
      {[
        { name: 'Recados', slug: 'recados', icon: 'book', value: 10 },
        { name: 'Fotos', slug: 'fotos', icon: 'camera', value: 4 },
        { name: 'Videos', slug: 'videos', icon: 'video-camera', value: 2 },
        { name: 'Fãs', slug: 'fas', icon: 'star', value: 1000 },
        { name: 'Mensagens', slug: 'mensagens', icon: 'email', value: 6  },
      ...
      {[
        ...
        { name: 'Legal', slug: 'legal', icon: 'cool', value: 0 },
        { name: 'Sexy', slug: 'sexy', icon: 'heart', value: 3 },
      ].map(({ name, slug, icon, value }) => {
        const total = props[slug] ? props[slug] : value;
        return (
          <li key={`orkut__icon_set__${slug}`}>
